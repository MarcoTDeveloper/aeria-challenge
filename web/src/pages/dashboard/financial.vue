    ...
    >
      ...
      <span
        class="
          ...
          tw-text-2xl
        "
      >{{ formatMoney(result?.balance) }}</span>
    </div>
    ...
    >
      ...
      >
        ...
        <img
          class="
            ...
            tw-h-6
          "
          src="../../../static/circle-arrow-up.svg"
        >
      </div>
      ...
      <span
        class="
          ...
          tw-text-2xl
        "
      >{{ formatMoney(result?.receiveTransaction) }}</span>
    </div>
    ...
    >
      ...
      >
        ...
        <img
          class="
            ...
            tw-h-6
          "
          src="../../../static/circle-arrow-down.svg"
        >
      </div>
      ...
      <span
        class="
          ...
          tw-text-2xl
        "
      >{{ formatMoney(result?.payTransactions) }}</span>
    </div>
  </div>
